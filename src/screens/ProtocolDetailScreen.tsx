...
import type { RootStackParamList, ProtocolStep } from '../types';
...
function StepCard({ step, isLast, colors, rs }: StepCardProps) {
  ...
  return (
    <View
      style={{ flexDirection: 'row', marginHorizontal: rs.space(SPACING.lg) }}
    >
      {/* Timeline column */}
        ...
        >
          ...
          <Text
            style={{
              ...
              color: colors.text,
              lineHeight: 21,
              marginBottom: step.detalles ? rs.space(6) : 0,
            }}
          >
            {step.accion}
          </Text>
          ...
          {step.farmacos && step.farmacos.length > 0 && (
            ...
            >
              ...
              {step.farmacos.map((f, i) => (
                <View
                  key={i}
                  style={{ flexDirection: 'row', marginBottom: rs.space(3) }}
                >
                  <MaterialCommunityIcons
                    name="pill"
                    size={12}
                    color={colors.nursing}
                    style={{ marginRight: rs.space(4), marginTop: 2 }}
                  />
                  <Text
                    style={{
                      flex: 1,
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                ...
                >
                  {protocol.categoria.charAt(0).toUpperCase() +
                    protocol.categoria.slice(1)}
                </Text>
              </View>
            </View>
          </View>
              ...
              {protocol.banderasRojas.map((flag, idx) => (
                <View
                  ...
                  style={{
                    ...
                    marginBottom:
                      idx < protocol.banderasRojas.length - 1
                        ? rs.space(SPACING.sm)
                        : 0,
                  }}
                >
            ...
            <View style={[neuCard(colors), styles.sectionCard]}>
              {protocol.resumenFarmacos.map((drug, idx) => (
                  ...
                  style={[
                    {
                      ...
                      borderBottomWidth:
                        idx < protocol.resumenFarmacos.length - 1 ? 0.5 : 0,
                ...
                >
                  ...
                  >
                    <Text style={{ fontWeight: '600' }}>Dosis: </Text>
                    {drug.dosis}
                  </Text>
                  <Text
                    style={{
                  ...
                  >
                    <Text style={{ fontWeight: '600' }}>Indicación: </Text>
                    {drug.indicacion}
                  </Text>
                </View>
              ))}
          ...
          <>
            ...
            <View
              style={[
                neuCard(colors),
                styles.sectionCard,
                { borderLeftWidth: 3, borderLeftColor: colors.nursing },
              ]}
            >
              {protocol.notasEnfermeria.map((nota, idx) => (
                <View
                  ...
                  style={{
                    ...
                    alignItems: 'flex-start',
                    marginBottom:
                      idx < protocol.notasEnfermeria.length - 1
                        ? rs.space(SPACING.sm)
                        : 0,
                  }}
                >
