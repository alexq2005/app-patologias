...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  },
  {
    ...
    image: require('../assets/images/scales/pain_scale.jpg'),
  },
];
...
export function HomeScreen({ navigation }: Props) {
  ...
  const { trialDaysLeft, trialExpired, isSubscribed, isCodeActivated } =
    usePremium();
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        <LinearGradient
          colors={
            isDark
              ? [
                  colors.gradientStart + '15',
                  colors.background,
                  colors.background,
                ]
              : [
                  colors.gradientStart + '08',
                  colors.background,
                  colors.primary + '05',
                ]
          }
      ...
      >
        ...
        >
          <Animated.View
            style={{
              opacity: anim0.opacity,
              transform: [{ translateY: anim0.translateY }],
            }}
          >
            {/* Top row */}
            <View
            ...
            {QUICK_ACTIONS.map(action => (
              ...
              >
                ...
                >
                  <LinearGradient
                    colors={[
                      action.gradient[0] + 'CC',
                      action.gradient[1] + 'EE',
                    ]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 0.5, y: 1 }}
                    style={{
        ...
        {pathologyOfTheDay && (
          ...
          >
            ...
            >
              <ImageBackground
                source={getConditionImage(
                  pathologyOfTheDay.id,
                  pathologyOfTheDay.bodySystemId as BodySystemId,
                )}
        ...
        {/* ── RECENTLY VIEWED ── */}
        <View
          style={{ marginTop: rs.space(28), paddingHorizontal: rs.space(20) }}
        >
          <Text
            style={{
              fontSize: rs.font(16),
          ...
          {recentPathologyObjects.length > 0 ? (
            <FlatList
              ...
              renderItem={({ item }) => {
                const sysColor =
                  BODY_SYSTEM_COLORS[item.bodySystemId] ?? colors.primary;
                return (
                  <TouchableOpacity
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                >
                  Accedé a {pathologyCount} patologías organizadas por sistema
                  corporal
                </Text>
              </View>
              <Text style={{ fontSize: rs.font(18), color: colors.textLight }}>
                →
              </Text>
            </TouchableOpacity>
          )}
        ...
        {!isSubscribed && !isCodeActivated && (
          <View
            style={{ marginTop: rs.space(24), paddingHorizontal: rs.space(20) }}
          >
            <TouchableOpacity
            ...
            >
              <LinearGradient
                colors={
                  trialExpired ? ['#DC2626', '#991B1B'] : ['#7C3AED', '#4F46E5']
                }
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 0 }}
                style={{
              ...
              >
                <Text style={{ fontSize: rs.font(24) }}>
                  {trialExpired ? '🔒' : '⏳'}
                </Text>
                <View style={{ flex: 1 }}>
                  <Text
                  ...
                  >
                    {trialExpired
                      ...
                      : `${trialDaysLeft} ${
                        ...
                        } restantes · Toca para ver planes`}
                  </Text>
                </View>
                <Text
                  style={{
